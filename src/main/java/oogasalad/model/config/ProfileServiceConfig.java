...
public class ProfileServiceConfig {
   ...
   */
  public static DocumentReference getDocumentRef(String documentId, String COLLECTION_NAME)
   ...
   */
  public static DocumentSnapshot getDocument(String documentId, String COLLECTION_NAME)
      throws DatabaseException {
    try {
   ...
   */
  public static boolean documentExists(String documentId, String COLLECTION_NAME)
      throws DatabaseException {
   ...
   */
  public static void addToDatabase(String documentId, String COLLECTION_NAME,
   ...
   */
  public static void deleteFromDatabase(String documentId, String COLLECTION_NAME)
      throws DatabaseException {
    try {
