...
public abstract class Behavior extends GameComponent {
  ...
  @Override
  public final ComponentTag componentTag() {
  ...
  /**
   * This the method that will be called when the behavior is set to enabled NOTE: This method
  ...
  /**
   * This the method that will be called when the behavior is set to disabled NOTE: This method
   * should be override if needed.
   */
