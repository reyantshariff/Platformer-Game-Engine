...
public class GUI {
  ...
  public GUI(Stage stage, Game game) {
    ResourceBundles.loadBundle("oogasalad.gui.resources.general");
    generateGUI(stage, game);
  }

  private void generateGUI(Stage stage, Game game) {
    Group root = new Group();
    Scene scene = new Scene(root, ResourceBundles.getInt("oogasalad.gui.resources.general", "windowWidth"), ResourceBundles.getInt("oogasalad.gui.resources.general", "windowHeight")); // size your game window here
    Canvas canvas = new Canvas(ResourceBundles.getInt("oogasalad.gui.resources.general", "windowWidth"), ResourceBundles.getInt("oogasalad.gui.resources.general", "windowHeight"));
    ...
    gameLoop.getKeyFrames().add(new KeyFrame(
        Duration.seconds((double) 1 / ResourceBundles.getDouble("oogasalad.gui.resources.general", "framesPerSecond")),
        event -> {
          game.step((double) 1 / ResourceBundles.getDouble("oogasalad.gui.resources.general", "framesPerSecond"));
  ...
  private void render(GraphicsContext gc, GameScene scene) {
    gc.clearRect(ResourceBundles.getInt("oogasalad.gui.resources.general", "windowX"), ResourceBundles.getInt("oogasalad.gui.resources.general", "windowY"), ResourceBundles.getDouble("oogasalad.gui.resources.general", "windowWidth"), ResourceBundles.getDouble("oogasalad.gui.resources.general", "windowHeight"));
